...
int main() {
    ...
    serverAddr.sin_addr.s_addr = INADDR_ANY; // serveur écoute toutes les interfaces réseau sur la machine
    //serverAddr.sin_addr.s_addr = inet_addr("172.17.0.1"); // use your own ip addr
